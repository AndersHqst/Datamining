...
\hfig{figures/kmedoids_content_pagerank.png}{0.6}{The content attributes clustered using K-Medoids. It is seen, that a large amount of content tends to result in a better PageRank.}{fig:cluster_content}
