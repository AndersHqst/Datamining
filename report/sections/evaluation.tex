...
\dbgfig{cluster_content.png}{1}{The content attributes clustered using K-Means, K-Medoids and DBSCAN. It is seen, that a large amount of content tends to result in a better PageRank.}{fig:cluster_content}
